...
export default function Sidebar({ className = '', onCloseMobile }) {
  ...
  return (
    <aside className={`w-64 bg-white dark:bg-[#12182B] border-r border-slate-200 dark:border-[#1E294B] flex flex-col shrink-0 z-20 h-full select-none overflow-hidden ${className}`}>
      {/* Brand header - pinned/stable at top */}
      <div className="flex items-center justify-between px-4 pt-4 pb-3 border-b border-slate-100 dark:border-[#1E294B]/60 shrink-0">
      ...
      {/* Independently Scrollable Container: Nav, System, Theme Switcher, Engine Status & Profile */}
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 flex flex-col justify-between gap-6 min-h-0">
        ...
        {/* Sidebar Lower Controls & Profile - scrollable into view on smaller heights */}
        <div className="flex flex-col gap-3 pt-3 border-t border-slate-200 dark:border-[#1E294B] shrink-0 mt-auto">
          {/* Theme Switcher */}
          <ThemeSwitcher />
